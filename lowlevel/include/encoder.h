 ...
 */
#define ENCODER_A_RCC_TIM RCC_TIM3
#define ENCODER_A_TIM TIM3

#define ENCODER_A_INVERSION 1

#define ENCODER_A_CH1_PORT GPIOA
#define ENCODER_A_CH1_PORT_RCC RCC_GPIOA
#define ENCODER_A_CH1_AF GPIO_AF2
#define ENCODER_A_CH1_PIN GPIO6

#define ENCODER_A_CH2_PORT GPIOA
#define ENCODER_A_CH2_PORT_RCC RCC_GPIOA
#define ENCODER_A_CH2_AF GPIO_AF2
#define ENCODER_A_CH2_PIN GPIO7
/** @} */
